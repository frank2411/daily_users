...
class TestUserChangePasswordActions:
    ...
    def test_user_change_password_fail_no_data(self, client, db, base_user, base_user_headers):
        data = {}
    ...
    def test_user_change_password_fail_no_old_password(self, client, db, base_user, base_user_headers):
        data = {
            "old_password": "",
    ...
    def test_user_change_password_fail_wrong_old_password(self, client, db, base_user, base_user_headers):
        data = {
            "old_password": "tes",
            "new_password": "test_valid@Test10",
            "new_password_confirm": "test_valid@Test10",
    ...
    def test_user_change_password_fail_password_mismatch(self, client, db, base_user, base_user_headers):
        data = {
            "old_password": "test",
            "new_password": "test_valid@Test10",
    ...
    def test_user_change_password_fail_empty_new_password(self, client, db, base_user, base_user_headers):
        data = {
            "old_password": "test",
            "new_password": "",
    ...
    def test_user_change_password_201(self, client, db, base_user, base_user_headers):
