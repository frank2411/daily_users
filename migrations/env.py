...
# Add daily_users_api folder to python path in oder to import metadata
import sys
import os

api_path = f'{os.getcwd()}'

if "daily_users" not in api_path:
    raise ValueError("Bad Current working directory")

sys.path.append(api_path)

from daily_users_api.models import db  # noqa
from daily_users_api.app import create_app  # noqa
